        ...
        <div class="mt-4">
            <div class="-mx-6 flex flex-wrap">
                <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                    ...
                    >
                        <div
                            class="bg-opacity-75 rounded-full bg-indigo-600 p-3"
                        >
                            <svg
                ...
                <div class="mt-6 w-full px-6 sm:mt-0 sm:w-1/2 xl:w-1/3">
                    <div
                        class="flex items-center rounded-md bg-white px-5 py-6 shadow-sm"
                    >
                        <div class="bg-opacity-75 rounded-full bg-blue-600 p-3">
                            <svg
                                class="h-8 w-8 text-white"
                                viewBox="0 0 28 28"
                                fill="none"
                ...
                <div class="mt-6 w-full px-6 sm:w-1/2 xl:mt-0 xl:w-1/3">
                    <div
                        class="flex items-center rounded-md bg-white px-5 py-6 shadow-sm"
                    >
                        <div class="bg-opacity-75 rounded-full bg-pink-600 p-3">
                            <svg
                                class="h-8 w-8 text-white"
                                viewBox="0 0 28 28"
                                fill="none"
