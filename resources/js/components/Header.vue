...
<template>
    <header
        class="flex items-center justify-between border-b-4 border-gray-600 bg-white px-6 py-4"
    >
                ...
                >
                    ...
                    >
                        ...
                        <Link
                            ...
                            method="post"
                            as="a"
                            class="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-600 hover:text-white"
                        >
                            Log out
                        </Link>
                    </div>
